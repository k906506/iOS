...
class StarViewController: UIViewController {
    ...
    private func configureCollectionView() {
        self.starCollectionView.collectionViewLayout = UICollectionViewFlowLayout()
        self.starCollectionView.contentInset = UIEdgeInsets(top: 10, left: 10, bottom: 10, right: 10)
