...
class ContentCollectionViewMainCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        imageView.snp.makeConstraints {
            $0.width.top.leading.equalToSuperview()
            $0.height.equalTo(imageView.snp.width) // 정사각형 이미지
        }
        ...
        [playButton, playButton, infoButton].forEach {
            contentStackView.addArrangedSubview($0)
        }
        
        contentStackView.snp.makeConstraints {
            $0.leading.trailing.equalToSuperview().inset(30)
            $0.leading.height.equalToSuperview().inset(60)
        }
        ...
        [tvButton, movieButton, categoryButton].forEach {
            ...
            $0.setTitleColor(.white, for: .normal)
            $0.layer.shadowColor = UIColor.black.cgColor // 타입 변환을 해줘야함
